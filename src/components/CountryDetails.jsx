...
//   return (
//     <div className="p-4 border mt-4 rounded-lg bg-gray-100">
//       <h1 className="text-2xl font-bold">{country.name.common}</h1>
//       <img src={country.flags.svg} alt="Flag" className="w-48 my-4" />
//       {country.coatOfArms?.svg && (
//         <img src={country.coatOfArms.svg} alt="Coat of Arms" className="w-32 my-2" />
//       )}
